...
`\texttt{Char}' (que puede ser una secuencia de escape) y \texttt{Base\#Value} es un entero en base \texttt{Base}, el cual 
debe ser un valor entero dentro del rango $2..36$.
